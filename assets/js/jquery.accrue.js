...
;(function( $, window, document, undefined ){
    ...
    $.fn.accrue.options = {
        ...
        response_basic: 
            '<div class="col-md-12"><div class="emi mb-3"><p class="mb-1 size20"><strong>Monthly Payment:</strong></p><span>Rs %payment_amount%</span></div>'+
            '<div class="emi mb-3"><p class="mb-1 size20"><strong>Total Interest:</strong></p><span>Rs %total_interest%</span></div>'+	
        '<div class="emi mb-3"><p class="mb-1 size20"><strong>Number of Payments:</strong></p><span>%num_payments%</span></div>'+
        '<div class="emi mb-3"><p class="mb-1 size20"><strong>Total Payments:</strong></p><span>Rs %total_payments%</span></div></div>',
        response_compare: '<p class="total-savings">Save Rs %savings% in interest!</p>',
    ...
    var get_field = function( elem, options, name ) {
        ...
        elem.find(".form").append(
            '<div class="accrue-field-'+name+'">'+
                '<p><label>'+options.field_titles[name]+':</label><br>'+
                '<input type="text" class="'+name+' form-control" value="'+options.default_values[name]+'" />'+
                ( options.field_comments[name].length>0 ? "<br> <small>"+options.field_comments[name]+"</small>" : '' )+'</p>'+
            '</div>');
...
/*
     FILE ARCHIVED ON 14:40:53 Jan 18, 2019 AND RETRIEVED FROM THE
     INTERNET ARCHIVE ON 13:57:49 Sep 02, 2021.
...
/*
playback timings (ms):
  captures_list: 109.31
  exclusion.robots: 0.106
  exclusion.robots.policy: 0.098
  RedisCDXSource: 2.029
  esindex: 0.009
  LoadShardBlock: 86.508 (3)
  PetaboxLoader3.datanode: 200.805 (5)
  CDXLines.iter: 18.02 (3)
  load_resource: 219.888 (2)
  PetaboxLoader3.resolve: 86.211 (2)
*/